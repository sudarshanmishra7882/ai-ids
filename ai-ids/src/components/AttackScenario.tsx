// ============================================================
// ATTACK SCENARIO PANEL — Phase Timeline & Controls
// ============================================================
...
const PHASES = [
  {
    phase: 1 as AttackPhase,
    label: 'Baseline',
    desc: 'Normal banking traffic patterns established',
    color: 'bg-green-500',
    textColor: 'text-green-400',
    borderColor: 'border-green-500/40',
  },
  {
    phase: 2 as AttackPhase,
    label: 'Beaconing',
    desc: 'Fixed 1-second C2 interval detected via entropy',
    color: 'bg-orange-500',
    textColor: 'text-orange-400',
    borderColor: 'border-orange-500/40',
  },
  {
    phase: 3 as AttackPhase,
    label: 'DB Exfil',
    desc: '400 queries/min via compromised DBA account',
    color: 'bg-red-500',
    textColor: 'text-red-400',
    borderColor: 'border-red-500/40',
  },
  {
    phase: 4 as AttackPhase,
    label: 'C2 Comms',
    desc: 'Unknown external IPs, large packet exfiltration',
    color: 'bg-red-600',
    textColor: 'text-red-300',
    borderColor: 'border-red-600/40',
  },
  {
    phase: 5 as AttackPhase,
    label: '⚠ APT Alert',
    desc: 'Correlation engine fires HIGH confidence alert',
    color: 'bg-red-700',
