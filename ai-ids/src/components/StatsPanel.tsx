    ...
    <div className="space-y-4">
      ...
      <div className="bg-slate-900/60 rounded-xl border border-slate-700/50 p-4">
        ...
        <div className="grid grid-cols-4 gap-3">
          ...
          <div className="text-center">
            <div className="text-2xl font-black text-purple-400 font-mono">{alertCounts.CRITICAL}</div>
            <div className="text-xs text-purple-600 font-mono">CRITICAL</div>
          </div>
        </div>
        ...
        {total > 0 && (
          <div className="mt-3 flex h-2 rounded-full overflow-hidden gap-0.5">
            ...
            <div className="bg-purple-500 transition-all duration-700 rounded-r-full"
              style={{ width: `${(alertCounts.CRITICAL / total) * 100}%` }} />
          </div>
        )}
