...
export default function App() {
  ...
  const isHigh = currentAlert === 'HIGH' || currentAlert === 'CRITICAL';
    ...
    >
      ...
      {isHigh && (
        <div
          ...
          style={{ border: currentAlert === 'CRITICAL' ? '2px solid rgba(168,85,247,0.4)' : '2px solid rgba(239,68,68,0.4)' }}
        >
          <div
            className="absolute w-full h-0.5 opacity-20"
            style={{
              background: currentAlert === 'CRITICAL'
            ...
            <div className="flex items-center gap-4">
              ...
              <div className={`px-3 py-1.5 rounded-lg border text-xs font-black font-mono tracking-widest ${
                currentAlert === 'CRITICAL'
                  ? 'bg-purple-900/50 border-purple-500/60 text-purple-300 high-alert-pulse'
                  : isHigh
  ...
  "log": {
    ...
    "networkSegment": "USER_LAN | SWIFT_SUBNET | ATM_SWITCH | CORE_BANKING_PUMORI | NRB_REGULATORY",
    "applicationLabel": "string",
    "telemetrySources": ["NetFlow/IPFIX", "Zeek", "Suricata", "..."],
  ...
  "agentBreakdown": { "PACKET": {}, "FLOW": {}, "BEHAVIOR": {}, "CORRELATION": {}, "RESPONSE": {} },
  "attackClassification": "C2_BEACONING | DATA_EXFILTRATION | LATERAL_MOVEMENT | ...",
  "detectionModes": ["SIGNATURE", "ANOMALY", "BEHAVIORAL", "ZERO_DAY"],
  "signatureMatches": ["string"],
  "zeroDayScore": "number (0-1)",
  "clusterOutlierScore": "number (0-1)",
  ...
  "correlationChain": ["string"]
            ...
            <div className="col-span-12 lg:col-span-4 space-y-4">
              ...
              <div className="bg-slate-900/60 rounded-xl border border-slate-700/50 p-4">
                ...
                <div className="space-y-2">
                  {[
                    { label: 'Response Time', value: '<750ms', color: 'text-green-400' },
